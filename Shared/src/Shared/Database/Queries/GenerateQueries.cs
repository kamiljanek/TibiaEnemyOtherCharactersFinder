...
ORDER BY number_of_matches DESC LIMIT 10";
        ...
        ///    @p0
        /// </summary>
        public const string NpgsqlGetSameCharacterCorrelations = @"WITH cte AS (SELECT * FROM character_correlations cc WHERE cc.logout_character_id = @p0 OR cc.login_character_id = @p0)
...
";
        ...
        ///    @p0
        /// </summary>
        public const string NpgsqlGetSameCharacterCorrelationsCrossed = @"WITH cte AS (SELECT * FROM character_correlations cc WHERE cc.logout_character_id = @p0 OR cc.login_character_id = @p0)
